  ...
  <div class="app-container">
    ...
    <el-table
        ...
        <template slot-scope="scope">
          <template>
            <el-tag
              ...
              v-if="scope.row.openComment == item.dictValue"
              :key="item.uid"
              :type="item.listClass">{{ item.dictLabel }}
            </el-tag>
          </template>
      ...
      <el-table-column
        ...
        <template slot-scope="scope">
          <template>
            <el-tag
              v-for="item in blogPublishDictList"
              v-if="scope.row.isPublish == item.dictValue"
              :key="item.uid"
              :type="item.listClass">{{ item.dictLabel }}
            </el-tag>
          </template>
      ...
      <el-table-column label="操作" fixed="right" min-width="150">
        <template slot-scope="scope">
          <el-button v-permission="'/blog/edit'" type="primary" size="small" @click="handleEdit(scope.row)">编辑
          </el-button>
          <el-button v-permission="'/blog/delete'" type="danger" size="small" @click="handleDelete(scope.row)">删除
          </el-button>
        </template>
      </el-table-column>
    ...
    >
      <el-form ref="form" :model="form" :rules="rules">
        ...
        <el-row>
          ...
          <el-col :span="8">
            <el-form-item :label-width="formLabelWidth" label="标题图">
              ...
              <div v-else-if="photoList" class="imgBody">
                <i
                  v-show="icon"
                  class="el-icon-error inputClass"
                  @click="deletePhoto()"
        ...
        <el-form-item v-if="form.type == 1" :label-width="formLabelWidth" label="外链" prop="outsideLink">
    ...
    >
      ...
      >
        ...
        <el-button style="margin-left: 10px;" size="small" type="success" @click="submitPictureUpload">
          提交到图片服务器
        </el-button>
      </el-upload>
...
import { randomImg } from '../../api/blog'
